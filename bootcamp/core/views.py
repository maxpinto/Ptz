...
from bootcamp.feeds.views import p_p_pagina
...
def profile(request, username):
    ...
    paginator = Paginator(all_feeds, p_p_pagina)
...
def settings(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            messages.add_message(request, messages.SUCCESS, 'Su perfil fue satisfactoriamente actualizado')
    else:
