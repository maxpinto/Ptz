...
class Notification(models.Model):
    ...
    NOTIFICATION_TYPES = (
        (LIKED, 'Le Gusta'),
        (COMMENTED, 'Comento'),
        (FAVORITED, 'Marco Favorita'),
        (ANSWERED, 'Respondio'),
        (ACCEPTED_ANSWER, 'Acepto Respuesta'),
        (EDITED_ARTICLE, 'Edito Articulo'),
        (ALSO_COMMENTED, 'Tambien comento'),
        )

    _LIKED_TEMPLATE = u'<a href="/{0}/">{1}</a> Le gusta tu publicacion: <a href="/feeds/{2}/">{3}</a>'
    _COMMENTED_TEMPLATE = u'<a href="/{0}/">{1}</a> comento tu publicacion: <a href="/feeds/{2}/">{3}</a>'
    _FAVORITED_TEMPLATE = u'<a href="/{0}/">{1}</a> marco tu pregunta como favorita: <a href="/questions/{2}/">{3}</a>'
    _ANSWERED_TEMPLATE = u'<a href="/{0}/">{1}</a> respondio tu pregunta: <a href="/questions/{2}/">{3}</a>'
    _ACCEPTED_ANSWER_TEMPLATE = u'<a href="/{0}/">{1}</a> acepto tu respuesta: <a href="/questions/{2}/">{3}</a>'
    _EDITED_ARTICLE_TEMPLATE = u'<a href="/{0}/">{1}</a> edito tu articulo: <a href="/article/{2}/">{3}</a>'
    _ALSO_COMMENTED_TEMPLATE = u'<a href="/{0}/">{1}</a> tambien comento en la publicacion: <a href="/feeds/{2}/">{3}</a>'
